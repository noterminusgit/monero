...
**Total**: 23 spec files + [bugs.md](bugs.md) + [untestable-lines.md](untestable-lines.md) + this index = 26 files, ~12,800 lines.
...
| File | Description |
|------|-------------|
| [bugs.md](bugs.md) | All discovered issues: 9 critical/security, 8 bugs, 125 tech debt items, 23 design concerns |
